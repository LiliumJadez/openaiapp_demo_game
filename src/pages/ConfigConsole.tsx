...
const DEFAULT_CONFIG: GameConfig = {
  ...
  audio: {
    ...
    fadeTime: 2000,
    weather: {
      sunny: '/music/Sunny Night.mp3',
      bloodRain: '/music/Blood Rain.mp3',
      fog: '/music/Fog.mp3',
      storm: '/music/Storm.mp3',
      aurora: '/music/Aurora.mp3',
      eclipse: '/music/Eclipse.mp3',
      starfall: '/music/Falling Star.mp3',
    },
    endings: {
      descent: '/audio/endings/descent.mp3',
      avarice: '/audio/endings/avarice.mp3',
      ascension: '/music/Meteor Shower.mp3',
